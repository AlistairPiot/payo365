        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-600 max-w-md">
              La solution ultra simple pour freelances et créateurs. Générez un lien de paiement et recevez vos paiements instantanément.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/legal/cgv" className="text-gray-600 hover:text-indigo-600 transition">
                  CGV
                </Link>
              </li>
              <li>
                <Link href="/legal/cgu" className="text-gray-600 hover:text-indigo-600 transition">
                  CGU
                </Link>
              </li>
              <li>
                <Link href="/legal/confidentialite" className="text-gray-600 hover:text-indigo-600 transition">
                  Confidentialité
                </Link>
              </li>
              <li>
                <Link href="/legal/mentions-legales" className="text-gray-600 hover:text-indigo-600 transition">
                  Mentions légales
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-600 text-sm">
              © {new Date().getFullYear()} Payo365. Tous droits réservés.
            </p>
