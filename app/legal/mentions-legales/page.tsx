                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 md:p-12">
                    ...
                    <div className="prose prose-indigo max-w-none">
                        <section className="mb-8">
                            ...
                            <p className="text-gray-700 mb-2">
                                <strong>Exploitant :</strong> Alistair Piot
                            </p>
                            <p className="text-gray-700 mb-2">
                            ...
                            <p className="text-gray-700 mb-2">
                                <strong>Immatriculation :</strong> Dispensé
                                d'immatriculation RCS (micro-entreprise)
                            </p>
                            <p className="text-gray-700 mb-2">
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-gray-700 mb-4">
                                ...
                                Payo365 (textes, graphismes, logo, icônes,
                                images, sons, logiciels, etc.) sont la propriété
                                exclusive de Payo365, à l'exception des marques,
                            ...
                            <p className="text-gray-700 mb-4">
                                ...
                                autorisation écrite préalable de Payo365.
                            </p>
                            <p className="text-gray-700 mb-4">
                        ...
                        <section className="mb-8">
                            ...
                            <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
                                ...
                                <li>
                                    <strong>Google OAuth :</strong> Pour
                            ...
                            <p className="text-gray-700 mb-4">
                                Ces services sont soumis à leurs propres
                                conditions d'utilisation et politiques de
                                confidentialité.
                            </p>
                        </section>
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-gray-700 mb-4">
                                Payo365 s'efforce d'assurer l'exactitude et la
                                mise à jour des informations diffusées sur ce
                                site, dont elle se réserve le droit de corriger,
                                à tout moment et sans préavis, le contenu.
                            </p>
                            <p className="text-gray-700 mb-4">
                                Toutefois, Payo365 ne peut garantir
                                l'exactitude, la précision ou l'exhaustivité des
                                informations mises à disposition sur ce site.
                            </p>
                            <p className="text-gray-700 mb-4">
                                En conséquence, Payo365 décline toute
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-gray-700 mb-4">
                                Le site Payo365 peut contenir des liens
                                hypertextes vers d'autres sites. Payo365
                                n'exerce aucun contrôle sur ces sites et décline
                                toute responsabilité quant à l'accès, au contenu
                                ou à l'utilisation de ces sites, ainsi qu'aux
                                dommages pouvant résulter de la consultation des
                                informations présentes sur ces sites.
                            </p>
                            <p className="text-gray-700 mb-4">
                                La création de liens hypertextes vers le site
                                Payo365 nécessite l'autorisation préalable
                                écrite de Payo365.
                            </p>
                        </section>
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-gray-700 mb-4">
                                Les informations concernant la collecte et le
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-gray-700 mb-4">
                                ...
                                bon fonctionnement. Pour plus d'informations,
                                consultez notre{" "}
                                <Link
                                    href="/legal/confidentialite"
                                    className="text-indigo-600 hover:underline"
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-gray-700 mb-4">
                                ...
                                le droit français. En cas de litige et à défaut
                                d'accord amiable, le litige sera porté devant
                                les tribunaux français conformément aux règles
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-gray-700 mb-4">
                                ...
                                recourir gratuitement à un médiateur de la
                                consommation en vue de la résolution amiable
                                d'un litige qui l'oppose à un professionnel.
                            </p>
                            <p className="text-gray-700 mb-4">
                                <strong>Médiateur compétent :</strong>
                            </p>
                            <p className="text-gray-700 mb-2">
                                Centre de Médiation de la Consommation de
                                Conciliateurs de Justice (CM2C)
                                <br />
                            ...
                            <p className="text-gray-700 mb-4 mt-4">
                                En cas de litige, vous pouvez déposer votre
                                réclamation sur la plateforme de résolution des
                                litiges en ligne de la Commission Européenne :{" "}
                                <a
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-gray-700 mb-4">
                                ...
                                complémentaire concernant ces mentions légales,
